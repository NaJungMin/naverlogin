...
<script type="text/javascript">
 ...
 var naver = NaverAuthorize({
  ...
  client_secret : "발급받은 시크릿 ID",
  redirect_uri : '돌아갈 주소' // 'http://'+'<%=request.servervariables("HTTP_HOST") & request.servervariables("HTTP_url") %>' (ASP 일 경우)
 });
...
네이버 API에 대해 제대로 이해못한것도 많고..

누구에게 정보를 주기위해 쓴 글이 아니기 때문에.. 아마 이해하기 힘드실겁니다

https://nid.naver.com/devcenter/docs.nhn?menu=Javascript#

여기에 쉽고 친절하게 설명이 다 되있습니다!!
...
1. 로그인 상태를 유지하기 위해서는 SESSION이나 COOKIE를 사용해야한다.

2. IE일때 리사이징 문제는  svctype=0 를 추가하면 된다. 

3. URL에 붙는 code와 state 파라미터는 매우 짜증이난다.
